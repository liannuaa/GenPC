...
- RoReg, the upgraded backend for YOHO-style point cloud descriptors:
    - Place the FCGF backbone checkpoint at ```tools/RoReg/checkpoints/FCGF/backbone/best_val_checkpoint.pth```,
    - Place the RoReg checkpoint at ```tools/RoReg/checkpoints/FCGF/GF/model_best.pth```.

#### Run on demo data

```python demo.py --img demo/indoor/source_rgb.png --pcd demo/indoor/target_pcd.ply```, then you should obtain a open3d window showing:
<img src="demo/indoor/result.png" alt="Network" style="zoom:50%;" />

```python demo.py --img demo/outdoor/000183.png --pcd demo/outdoor/000189.npy```, then you should obtain a open3d window showing:
<img src="demo/outdoor/result.png" alt="Network" style="zoom:50%;" />

Use RoReg instead of YOHO by adding ```--feature_backend roreg```:
```python demo.py --img demo/outdoor/000183.png --pcd demo/outdoor/000189.npy --feature_backend roreg```
