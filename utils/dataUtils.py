...
CATEGORY_BY_ID = {
    ...
    "05117": "chair",
    "05452": "armchair",
    "06127": "a vase with leafy plant",
    "06145": "table",
    "06188": "motorcyle",
    "06830": "tricycle",
    "07136": "sofa",
    "07089": "upside-down motorcycle",
    "07155": "sign",
...
def getCategory(flag:str):
    taxonomy_id = str(flag).split("-")[0]
    if taxonomy_id in SHAPENET_CATEGORY_BY_TAXONOMY:
        return SHAPENET_CATEGORY_BY_TAXONOMY[taxonomy_id]
