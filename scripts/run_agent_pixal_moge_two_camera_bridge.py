...
def main() -> None:
    ...
    base.write_points(Path(f"{stem}_bridge_registered_100k.ply"), registered_bridge)
    base.write_points(Path(f"{stem}_registered_100k.ply"), registered)
    base.write_compare(Path(f"{stem}_partial_gray_pixal_red.ply"), partial, registered)
