...
def main() -> None:
    ...
    prior = base.load_points(args.pixal_prior)
    moge = base.load_points(args.native_moge)
    ...
    base.write_points(Path(f"{stem}_bridge_registered_100k.ply"), baseline)
    ...
    base.draw_projection_overlay(Path(f"{stem}_saved_view_projection.png"), args.semantic, partial, result, partial_projector)
    record = {
