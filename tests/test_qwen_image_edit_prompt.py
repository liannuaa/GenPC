...
class QwenImageEditPromptTest(unittest.TestCase):
    ...
    def test_generate_runs_two_plus_stages_then_downscales_to_requested_size(self):
        ...
        self.assertEqual(calls[0]["prompt"], "这是一个汽车的深度图，补全它。输出仍然是灰度深度图。")
        ...
        self.assertEqual(editor.last_stage1_prompt, "这是一个汽车的深度图，补全它。输出仍然是灰度深度图。")
