    ...
    def render_to_moge_sim3_reg(self, flag):
        ...
        run_render_to_moge_sim3(
            SimpleNamespace(
                ...
                partial_refine_iterations=int(getattr(self.cfg, "render_sim3_partial_refine_iterations", 80)),
                partial_refine_max_pairs=int(getattr(self.cfg, "render_sim3_partial_refine_max_pairs", 12000)),
                ...
                partial_refine_max_delta_scale=float(getattr(self.cfg, "render_sim3_partial_refine_max_delta_scale", 1.1)),
